...
/// A delegate type to allow scene managers to notify other objects that a scene change has occurred.
...
/// A manager type to handle the presentation and preloading of scenes to minimize time spent waiting.
final class SceneManager {
    ...
    /// A mapping of ``SceneMetadata`` instances to each resource.
